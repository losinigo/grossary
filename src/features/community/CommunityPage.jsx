/**
 * CommunityPage — Discover and search contributors.
 * Shows a feed of followed users' activity and a leaderboard of top contributors.
 */
...
export default function CommunityPage() {
  ...
  const handleSearch = (e) => { e.preventDefault(); setSearchTerm(query.trim()) }
  ...
  return (
    <div className="page">
      ...
      {!isSearching && user && feed?.length > 0 && (
        <>
      ...
      {/* Contributor list (search results or leaderboard) */}
      {list?.length > 0 && (
