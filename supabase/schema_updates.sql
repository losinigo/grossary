-- ============================================================
-- Schema Updates for Weighted Items Support
-- Run this in Supabase SQL Editor after your existing schema
-- ============================================================

-- Add unit fields to products table
ALTER TABLE products 
ADD COLUMN unit_type TEXT DEFAULT 'piece' CHECK (unit_type IN ('piece', 'weight', 'volume')),
ADD COLUMN unit_name TEXT DEFAULT 'piece',
ADD COLUMN unit_abbreviation TEXT DEFAULT 'pc';

-- Add unit fields to prices table  
ALTER TABLE prices
ADD COLUMN unit_quantity NUMERIC(10,3) DEFAULT 1.0 CHECK (unit_quantity > 0),
ADD COLUMN price_per_unit NUMERIC(10,2) GENERATED ALWAYS AS (price / unit_quantity) STORED;

-- Update current_prices view to include unit information
...
-- Update search functions to include unit information
...
-- Add some common unit presets
INSERT INTO products (name, brand, unit_type, unit_name, unit_abbreviation) VALUES
('Ground Beef Lean', NULL, 'weight', 'kilogram', 'kg'),
('Regular Potatoes', NULL, 'weight', 'kilogram', 'kg'),
('Chicken Breast', NULL, 'weight', 'kilogram', 'kg'),
('Tomatoes', NULL, 'weight', 'kilogram', 'kg'),
('Onions', NULL, 'weight', 'kilogram', 'kg')
